class Item(object):
    ...
    # data should => (name(str), descrip(str), carry(bit), breakable(int), health(int),
    # weight(int), droppable(bit), equipable(bit), attack_dmg(int)) 
    ...
    def examine_info(self):
        return (self.description, str(self.weight)+"lbs", str(self.attack_dmg)+"pts")